    ...
    <nav className="bg-white shadow-sm sticky top-0 z-50 backdrop-blur-sm border-b border-gray-100">
      <div className="container mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <a href="#about" className="text-prana-navy hover:text-prana-blue smooth-transition navbar-item font-medium">
            Tentang Kami
          </a>
          <a
            href="#services"
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-white px-6 py-3 animate-slide-in border-t border-gray-100">
          ...
          <a href="#about" className="block py-2 text-prana-navy hover:text-prana-blue smooth-transition font-medium">
            Tentang Kami
          </a>
          <a
            href="#services"
